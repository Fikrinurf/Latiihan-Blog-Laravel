        ...
        <div class="card mt-3">
            <div class="card-body px-4">
                <div class="d-flex justify-content-between col-lg">
                    ...
                    <div class="mt-3">
                        <a href="{{ url('/dashboard/artikel') }}" class="btn btn-transparent text-primary mb-2"><i
                ...
                <div class="col lg">
                    ...
                    <form action="{{ url('/dashboard/artikel/' . $data->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul"
                                name="judul" value="{{ old('judul', $data->judul) }}" onkeyup="getSlug()">
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                name="slug" value="{{ old('slug', $data->slug) }}" readonly>
                            @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            @if ($data->gambar)
                                <img src="{{ asset('images/' . $data->gambar) }}"
                                    class="img-fluid tampil-gambar mb-3 d-block" width="500px" alt="">
                            @else
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tag') is-invalid @enderror" id="tokenfield"
                                name="tag" value="{{ old('tag', $tags) }}">
                            @error('tag')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            <label for="isi" class="form-label">Isi dari artikel</label>
                            @error('isi')
