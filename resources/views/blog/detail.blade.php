    ...
    <div class="col-lg-8">
        <header class="mb-4">
            ...
            <div class="text-muted fst-italic mb-2">
                Diposting {{ $article->created_at->format('d F Y') . ' oleh ' . $article->user->name }} - Kategori <a
        ...
        <a href="/artikel" class="text-decoration-none mb-3"><i class="fa-solid fa-arrow-left"></i> Kembali </a>
    </div>
@endsection
